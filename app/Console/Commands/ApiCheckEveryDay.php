...
class ApiCheckEveryDay extends Command
{
    protected $signature = 'app:api-check-every-day';
    protected $description = 'Har kunlik tekshiruv';

    public function handle()
    {
        $getApis = DB::connection('oracle')->table('tbldata')->where('type_id', 1200)->where('int03', 1)->where('astate', 1)->get();
        ...
        foreach ($getApis as $getApi) {
            ...
            if ($checkStatus) {
                ...
                $this->info('Har kunlik tekshiruv xabari telegramga jo\'natildi.');
            }
        }
    }
}
