...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb bg-light p-2 px-4">
            ...
            <li class="breadcrumb-item active" aria-current="page">Қабул қилувчи интеграциялар жадвали</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header" style="margin-bottom: 0px !important;">
                    <h6 class="card-title text-muted" style="margin-bottom: 0px;">Қабул қилувчи интеграциялар</h6>
                </div>
                <div class="card-body">
